...
const HeaderHero = (props: Props) => {
  return (
    <header className="hero">
      <img
        className="hero__background max-w-fit md:max-w-full"
        srcSet={`${mediumPope} 750w, ${largePope} 1440w`}
      ...
      <div className="max-centered">
        <div className="hero__featured-card">
          ...
          <div className="featured-card__content">
            ...
            <h2 className="featured-card__title">{stg('pope_francis')}?</h2>
            <p className="featured-card__desc">{stg('hero_description')}</p>
            <p className="featured-card__more-info">
              <a className="flex underline" href="http://wikipedia.com">
                <svg
            ...
            <p className="featured-card__cta">{stg('what_is_your_veredict')}</p>
