...
import mediumPope from '../../assets/img/pope-francis.png'
import largePope from '../../assets/img/pope-francis.@2x.png'
...
const HeaderHero = (props: Props) => {
  return (
    <header className="w-full 2xl:h-[90vh] h-[90vh]  sm:h-[70vh] lg:h-screen">
      <div className="relative w-full h-full">
        <img
          className="absolute top-0 left-0 w-full h-full lg:h-screen object-cover"
          src={largePope}
          alt="Pope Francis"
        />
        <div className="max-centered">
          <div className="hero__featured-card">
            ...
            <div className="featured-card__content">
              <p className="text-white text-xs xl:text-base 2xl:text-base font-light">
                {stg('what_is_your_opinion')}
              </p>
              <h2 className="text-white text-3xl 2xl:text-5xl 2xl:py-2 font-normal">
                {stg('pope_francis')}?
              </h2>
              <p className="text-white text-sm xl:text-xl 2xl:text-2xl xl:w-[90%] font-light py-2 ">
                {stg('hero_description')}
              </p>
              <p className="featured-card__more-info">
                ...
                >
                  ...
                  {stg('more_information')}
                </a>
              </p>
              <p className="2xl:py-2 my-2 featured-card__cta">
                {stg('what_is_your_veredict')}
              </p>
        ...
        <div className="absolute bottom-0 flex w-full h-12 bg-[#ffffff]/40">
          <div className="closing-gauge__left">
            <span className="closing-gauge__title">{stg('closing_in')}</span>
          </div>
          <div className="closing-gauge__right">
            <span className="closing-gauge__number">22</span>
            <span className="closing-gauge__desc">{stg('days')}</span>
          </div>
        </div>
      </div>
    </header>
