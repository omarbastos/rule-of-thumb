  ...
  return (
    <footer className="footer">
      <div className="footer__links">
        <ul>
          <li>
            <a aria-label={stg('terms_and_conditions')} href="#">
              {stg('terms_and_conditions')}
            </a>
          </li>
          <li>
            <a aria-label={stg('privacy_policy')} href="#">
              {stg('privacy_policy')}
            </a>
          </li>
          <li>
            <a aria-label={stg('contact_us')} href="#">
              {stg('contact_us')}
            </a>
          </li>
        </ul>
